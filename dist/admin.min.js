...
var _Closer = __webpack_require__(6);
...
exports.default = {
    ...
    hideLoading: function hideLoading() {
        ...
        setTimeout(function () {
            ...
            _this._loadingBox.classList.remove('loading');
    ...
    _createClass(_class, [{
        ...
        value: function changeLanguage(language, locale) {
            ...
            (0, _jquery2.default)('[data-locale]').each(function () {
                ...
                (0, _jquery2.default)('[data-locale="' + phrase + '"]').html(locale[phrase]);
            });
...
var _class = function () {
    ...
    _createClass(_class, [{
        ...
        value: function executeRoute() {
            ...
            var View = __webpack_require__(11)("./" + routes[_Global2.default.routeAction[0]] + '.js').default;
