...
exports.default = {
    ...
    showValidationResults: function showValidationResults(element, locale, hide, callback) {
        ...
        for (var i in translate.locale) {

            for (var j in translate.locale[i]) {
    ...
    reloadPackery: function reloadPackery(timeout) {
...
exports.default = {
    ...
    fetchViewHTML: function fetchViewHTML() {
        var _this = this;

        var url = _Router2.default.createLink(_Global2.default.routeAction);

        _Ajax2.default.get(url, function (response) {
            _this.viewHTML = response;
            _this.replaceViewHTML(_this);
        }, function (response) {
            // Handle error event
        });
    },
