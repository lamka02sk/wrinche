...
class ResetPassword extends Login {
    ...
    /**
     * @var string
     * Contains new password chosen by the user
     */
    public $password;
    ...
    public function changePassword() {
        ...
        $crypto = new Crypto;
        $password = $crypto->encryptPassword($this->password);
    ...
    public function checkOldPasswords() {
        ...
        foreach($passwords as $password) {
            ...
            if($crypto->verifyPassword($this->password, $password))
    ...
    public function checkPasswords() {
        ...
        // Verify password
        $crypto = new Crypto;
        if($crypto->verifyPassword($this->password, $currentPassword))
            new UserEvents(9);  // New password equals to old password

        // Check old user passwords
