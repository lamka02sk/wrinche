function CategoryComponents() {
    ...
    this.title = {
        ...
        start: function() {
            this.title.data.value = document.querySelector('input[name=new_category_name]').value.trim()
        }.bind(this),
    ...
    this.url = {
        ...
        start: function() {
            this.url.data.value = document.querySelector('input[name=new_category_url]').value.trim();
        }.bind(this),
    ...
    this.description = {
        ...
        start: function() {
            this.description.data.text = document.querySelector('textarea[name=new_category_description]').value.trim();
        }.bind(this),
    ...
    this.parent = {
        ...
        start: function() {
            this.parent.data.value = document.querySelector('select[name=new_category_parent] option[selected]').getAttribute('value');
            new Selector({
    ...
    this.thumbnail = {
        ...
        start: function() {
            if(document.querySelector('div.header_image-image.category-image-instance'))
                this.thumbnail.data.path = document.querySelector('div.header_image-image.category-image-instance').getAttribute('data-path');
        }.bind(this),
    ...
    this.visibility = {
        ...
        start: function() {
            this.visibility.data.value = !!(document.querySelector('input[name=new_category_visibility]').checked);
        }.bind(this),
...
// Init components
components = new CategoryComponents();
...
document.querySelector('button.action-button.save-button').addEventListener('click', function() {
    ...
    postData(URI + 'category', data, function(response, type) {
